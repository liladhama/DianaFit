    ...
    const breakfasts = {
      ...
      keto: [
        { 
          ...
          ingredients: [
            { name: 'Авокадо', amount: 150, unit: 'г' },
    ...
    const snacks = {
      ...
      keto: [
        { 
          ...
          ingredients: [
            { name: 'Орехи макадамия', amount: 30, unit: 'г' }
          ]
        }
      ],
      default: [
    ...
    const lunches = {
      ...
      keto: [
        { 
          ...
          ingredients: [
            { name: 'Авокадо', amount: 100, unit: 'г' },
            { name: 'Моцарелла', amount: 80, unit: 'г' },
            { name: 'Листья салата', amount: 60, unit: 'г' },
            { name: 'Оливковое масло', amount: 15, unit: 'мл' },
            { name: 'Кедровые орехи', amount: 15, unit: 'г' }
          ]
        }
      ],
      default: [
    ...
    const dinners = {
      ...
      keto: [
        { 
          ...
          ingredients: [
            { name: 'Авокадо', amount: 100, unit: 'г' },
            { name: 'Грецкие орехи', amount: 25, unit: 'г' },
