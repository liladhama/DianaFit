  ...
  return (
    <div className="splash-container">
      ...
      <div className="splash-bottom-block">
        <img src={require('../assets/welcome/diana.png')} alt="Диана" className="splash-diana" style={{width: '400px', minWidth: '400px', height: 'auto', maxWidth: 'none', display: 'block', objectFit: 'contain', marginLeft: '110px'}} />
        <img src={require('../assets/welcome/yoga-mat.png')} alt="йога коврик" className="splash-yoga" style={{position: 'absolute', left: '10px', bottom: '60px', width: '110px', height: 'auto', objectFit: 'contain'}} />
      </div>
    </div>
  );
};
